...
class TrajOptimizer:
    ...
    def _obj_func(self, x):
        ...
        # franka panda 
        # checked
        # qIni = np.array([deg2rad(0), deg2rad(30), deg2rad(0), deg2rad(-90), deg2rad(0), deg2rad(150), deg2rad(0)])            
        # qIni = np.array([deg2rad(0), deg2rad(-45), deg2rad(0), deg2rad(-135), deg2rad(0), deg2rad(90), deg2rad(45)])            
